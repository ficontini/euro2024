...
type MatchesClient interface {
	...
	GetEuroWinner(ctx context.Context, in *WinnerRequest, opts ...grpc.CallOption) (*WinnerResponse, error)
}
...
func (c *matchesClient) GetEuroWinner(ctx context.Context, in *WinnerRequest, opts ...grpc.CallOption) (*WinnerResponse, error) {
	out := new(WinnerResponse)
	err := c.cc.Invoke(ctx, "/Matches/GetEuroWinner", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MatchesServer interface {
	...
	GetEuroWinner(context.Context, *WinnerRequest) (*WinnerResponse, error)
...
func (UnimplementedMatchesServer) GetEuroWinner(context.Context, *WinnerRequest) (*WinnerResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetEuroWinner not implemented")
}
...
func _Matches_GetEuroWinner_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WinnerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MatchesServer).GetEuroWinner(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Matches/GetEuroWinner",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MatchesServer).GetEuroWinner(ctx, req.(*WinnerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Matches_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetEuroWinner",
			Handler:    _Matches_GetEuroWinner_Handler,
		},
	},
